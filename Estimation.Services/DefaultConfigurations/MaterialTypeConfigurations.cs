...
namespace Estimation.Services.DefaultConfigurations
{
    public class MaterialTypeConfigurations: ConfigurationDict
    {
        ...
        public static readonly ConfigurationEntry MechanicType = new ConfigurationEntry() { Label = "Mechanic", Value = null, InternalDescription = "Mechanic material type." };
        ...
        public static readonly string DictTitle = "MaterialType";
